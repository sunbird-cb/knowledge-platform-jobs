...
class CollectionsContentStateSyncFn(config: CollectionsContentStateSyncConfig, httpUtil: HttpUtil)
                                   (implicit val stringTypeInfo: TypeInformation[String],
                                   @transient var cassandraUtil: CassandraUtil = null)
  extends BaseProcessKeyedFunction[String, Event, String](config) with ContentStateSyncHelper {
    ...
    def getProgramChildren(programId: String)(metrics: Metrics, config: CollectionsContentStateSyncConfig, cache: DataCache, httpUtil: HttpUtil):  java.util.Map[String, AnyRef] = {
