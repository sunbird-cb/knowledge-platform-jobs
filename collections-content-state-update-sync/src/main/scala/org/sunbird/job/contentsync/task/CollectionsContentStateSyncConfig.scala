...
class CollectionsContentStateSyncConfig(override val config: Config) extends BaseJobConfig(config, "program-cert-pre-processor") {
    ...
    val collectionsContentStateSyncProcess: String = "collections_content_state_sync"
